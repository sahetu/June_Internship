...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyHolder> {
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            addCart = itemView.findViewById(R.id.custom_product_add_cart);
            removeCart = itemView.findViewById(R.id.custom_product_remove_cart);
            wishlistBlank = itemView.findViewById(R.id.custom_product_wishlist_blank);
            wishlistFill = itemView.findViewById(R.id.custom_product_remove_wishlist);
        }
    }
